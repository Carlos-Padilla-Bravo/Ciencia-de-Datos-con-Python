...
# Cambio nombre de archivo para entrega primer sprint

Se decidió cambiar el nombre del archivo `Documentación.md` a `Documentación-v2.md`, así como el nombre del programa interactivo Python de `documentacion_interactiva.py` a `documentacion_interactiva-v2.py`, para reflejar que ambos archivos contienen la versión actualizada del proyecto luego de incorporar las sugerencias propuestas por los agentes de IA.

Tanto el código del programa interactivo Python como el archivo README fueron actualizados para reflejar estos cambios de nombre.
